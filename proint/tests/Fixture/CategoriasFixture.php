...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'quantidad_hora_minima' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'quantidad_hora_maxima' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'quantidad_hora_minima' => 1,
            'quantidad_hora_maxima' => 1,
            'criado_por' => 1,
            'created' => '2017-05-20 21:40:40',
            'modificado_por' => 1,
            'modified' => '2017-05-20 21:40:40'
        ],
    ];
}
